...
const htm_rwm = ["U", "U2", "U'", "F", "F2", "F'", "R", "R2", "R'",
    "r", "r2", "r'", "D", "D2", "D'", "M", "M'", "M2", "B", "B'", "B2"]
const rrwmu = ["U", "U'", "U2", "R", "R'", "R2",
    "r", "r'", "r2", "M'", "M", "M2"]
const rrwmu_m_first = ["U", "U'", "U2", "R", "R'", "R2", "M'", "M", "M2",
"r", "r'", "r2"]
const rrwmu_f = ["U", "U'", "U2", "R", "R'", "R2",
    "r", "r'", "r2", "M'", "M", "M2", "F'", "F", "F2"]
const rrwmu_b = ["U", "U'", "U2", "R", "R'", "R2",
